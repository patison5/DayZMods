class DeCraftImprovisedBag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ImprovisedBag");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("BurlapSack");//add results here
