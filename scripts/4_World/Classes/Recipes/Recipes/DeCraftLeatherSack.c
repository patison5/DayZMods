class DeCraftLeatherSack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_DeCraftLeatherSack0";//"BREAK LEATHER SACK";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"LeatherSack_ColorBase");//you can insert multiple ingredients this way
