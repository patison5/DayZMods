class DeCraftCamoNetShelter extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CamoNetShelter");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("CamoNet");//add results here
