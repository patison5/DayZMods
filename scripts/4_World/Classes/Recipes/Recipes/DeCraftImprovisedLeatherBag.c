class DeCraftImprovisedLeatherBag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"FurImprovisedBag");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("WildboarPelt");//add results here
		
		m_ResultSetFullQuantity[1] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[1] = 3;// -1 = do nothing
